...
import { arrayToHorusPayObject, stripApiVersion } from './Util';

/**
 * Class HorusPayObject
 */
export class HorusPayObject {
    [key: string]: any;
    ...
    refreshFrom(values: any, opts: any) {
        for (let k in values) {
            ...
            if (isPlainObject(value) || Array.isArray(value)) {
                ...
                this[k] = arrayToHorusPayObject(value, opts);
            } else {
                this[k] = value;
            }
        }
    ...
    serializeParameters(): any {
        ...
        for (let key in this) {
            ...
            if(value instanceof HorusPayObject){
