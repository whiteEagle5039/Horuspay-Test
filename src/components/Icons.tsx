...
export const IconUsers = ({ size, ...props }: IconProps) => (
  <svg {...defaults(size)} {...props}>
...
export const IconHexagon = ({ size, ...props }: IconProps) => (
  <svg {...defaults(size)} {...props}>
...
export const IconArrowRight = ({ size, ...props }: IconProps) => (
  <svg {...defaults(size)} {...props}>
    <line x1="5" y1="12" x2="19" y2="12" />
...
export const IconInbox = ({ size, ...props }: IconProps) => (
  <svg {...defaults(size)} {...props}>
...
export const IconLayers = ({ size, ...props }: IconProps) => (
  <svg {...defaults(size)} {...props}>
...
export const IconKey = ({ size, ...props }: IconProps) => (
  <svg {...defaults(size)} {...props}>
...
export const IconGithub = ({ size, ...props }: IconProps) => (
  <svg {...defaults(size)} {...props}>
